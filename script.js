...
var typed = new Typed(".multiple-text", {
    strings: ["WordPress Developer", "web Designer", "Web Developer"],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
...
const skilsArr = ["HTML", "CSS", "Bootstrap", "jQuery", "Javascript", "PHP", "MYSQL", "WordPress",];
const skillsIcons = ["<i class='bx bxl-html5'></i>", "<i class='bx bxl-css3'></i>", "<i class='bx bxl-bootstrap'></i>", "<i class='bx bxl-jquery'></i>", "<i class='bx bxl-javascript'></i>", "<i class='bx bxl-php'></i>", "<i class='bx bxl-mysql'></i>", "<i class='bx bxl-wordpress'></i>",];
const skillsColors = ["Tomato", "DodgerBlue", "SlateBlue", "rgb(15, 184, 240)", "rgb(228, 175, 0)", "rgb(15, 184, 240)", "#6cc24a", "Violet", "#6cc644", "rgb(15, 184, 240)"];
...
const portfolioImgs = ["./assets/portfolio1.png", "./assets/portfolio2.png", "./assets/portfolio3.png", "./assets/portfolio4.png"];
const portfolioHeadings = ["SEO Company Website", "Travel Company Website", "Education Meeting Website", "Food website"];
